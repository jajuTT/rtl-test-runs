...
if "__main__" == __name__:
    ...
    t3sim_args["rtl_tag"]                      = "".join(rtl_args["test_bench_dir_path"].split(os.path.sep)[-2:])
    ...
    # mnemonics_tpt = get_instructions_throughput(rtl_args, t3sim_args)
    # max_key_len = max([len(key) for key in mnemonics_tpt.keys()])
